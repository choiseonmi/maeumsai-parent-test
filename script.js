...
const questions = [
    ...
    {n:1, 
        kind:"type", 
        type:6, 
        text:"아이에게 생길 수 있는 문제를 미리 생각하고 대비하는 편이다."
    },
    {n:2, 
        kind:"attitude", 
        area:"support", 
        text:"아이가 속상해할 때 잘못을 따지기보다 먼저 마음을 들어주려 한다."
    },
    {n:3, 
        kind:"battery", 
        area:"body", 
        text:"아이를 돌보고 나면 몸에 힘이 거의 남아 있지 않을 때가 있다."
    },
    {n:4, 
        kind:"type", 
        type:4, 
        text:"아이가 남들과 달라도 자기만의 방식으로 표현하는 것이 중요하다고 생각한다."
    },
    {n:5, 
        kind:"battery", 
        area:"responsibility", 
    ...
    {n:6, 
        kind:"type", 
        type:8, 
        text:"아이에게 문제가 생기면 내가 먼저 나서서 해결하려는 편이다."
    },
    {n:7, 
        kind:"attitude", 
        area:"autonomy", 
        text:"아이가 스스로 할 수 있는 일은 시간이 걸려도 직접 해보도록 기다려준다."
    },
    {n:8, 
        kind:"type", 
        type:2, 
    ...
    {n:9, 
        kind:"battery", 
        area:"emotion", 
        text:"아이를 돌보다 보면 작은 일에도 쉽게 짜증이 날 때가 있다."
    },
    {n:10, 
        kind:"type", 
        type:3, 
        text:"아이가 목표를 세우면 어떻게 해낼지 함께 계획하는 편이다."
    },
    {n:11, 
        kind:"attitude", 
        area:"structure", 
        text:"우리 집에서 지켜야 할 중요한 규칙은 아이에게 분명하게 알려주는 편이다."
    },
    {n:12, 
        kind:"battery", 
        area:"self", 
    ...
    {n:14, 
        kind:"attitude", 
        area:"listen", 
        text:"아이가 이야기할 때 바로 해결책을 말하기보다 끝까지 들어주려 한다."
    },
    {n:15, 
        kind:"battery", 
        area:"body", 
        text:"쉬거나 잠을 자도 피로가 충분히 풀리지 않을 때가 있다."
    },
    {n:16, 
        kind:"type", 
        type:5, text:"아이에게 문제가 생기면 바로 반응하기보다 먼저 상황을 알아보려 한다."
    },
    {n:17, 
        kind:"battery", 
        area:"responsibility", 
        text:"쉬는 시간에도 해야 할 양육과 집안일이 계속 떠오른다."
    },
    {n:18, 
        kind:"type", 
        type:1, 
        text:"아이가 규칙을 지키지 않으면 그냥 넘어가기보다 바로잡아주고 싶어진다."
    },
    {n:19, 
        kind:"attitude", 
        area:"autonomy",
        text:"위험하지 않은 일이라면 아이가 직접 선택하고 경험하도록 두는 편이다."
    },
    {n:20, 
        kind:"type", 
        type:7, 
        text:"아이와 새로운 장소나 놀이를 함께 경험하는 것을 좋아한다."
    },
    {n:21, 
        kind:"battery", 
        area:"emotion", 
        text:"아이에게 따뜻하게 반응하고 싶어도 마음의 여유가 없을 때가 있다."
    },
    {n:22,
        kind:"type", 
        type:1, 
        text:"부모라면 힘들어도 맡은 책임은 제대로 해야 한다고 생각한다."
    },
    {n:23, 
        kind:"attitude", 
        area:"structure", 
        text:"내가 피곤한 날에도 중요한 규칙은 되도록 같은 기준으로 적용하려 한다."
    },
    {n:24, 
        kind:"type", 
        type:2, 
    ...
    {n:25, 
        kind:"battery", 
        area:"relationship", 
        text:"아이를 돌보는 일을 나 혼자 감당하고 있다고 느낄 때가 있다."
    },
    {n:26, 
        kind:"type", 
        type:3, 
    ...
    {n:27, 
        kind:"attitude", 
        area:"listen", 
        text:"문제가 생기면 아이의 생각을 먼저 물어보고 함께 해결방법을 찾으려 한다."
    },
    {n:28, 
        kind:"type", 
        type:4, 
        text:"아이의 말이나 행동 뒤에 어떤 마음이 있는지 생각해보는 편이다."
    },
    {n:29, 
        kind:"battery", 
        area:"relationship", 
        text:"양육이 힘들어도 다른 사람에게 도움을 요청하기 어렵다."
    },
    {n:30, 
        kind:"type", 
        type:5, 
        text:"아이와 갈등이 생기면 바로 말하기보다 생각을 정리한 뒤 이야기하는 편이다."
    },
    {n:31, 
        kind:"type", 
        type:6, 
        text:"중요한 양육 결정을 할 때 다른 사람의 의견이나 정보를 확인해야 마음이 놓인다."
    },
    {n:32, 
        kind:"battery", 
        area:"self",
        text:"부모 역할 때문에 내가 좋아하는 일이나 하고 싶은 일을 자주 미루게 된다."
    },
    {n:33, 
        kind:"type", 
        type:7, 
        text:"답답한 분위기가 오래 이어지면 다른 방법으로 분위기를 바꾸고 싶어진다."
    },
    {n:34, 
        kind:"type", 
        type:8, 
    ...
    {n:35, 
        kind:"type", 
        type:9, 
        text:"아이와 의견이 다를 때 서로 맞출 수 있는 방법을 찾으려 한다."
    },
    {n:36, 
        kind:"attitude", 
        area:"support", 
        text:"결과가 좋지 않아도 아이가 노력한 과정이나 잘한 점을 먼저 말해주는 편이다."
    }
